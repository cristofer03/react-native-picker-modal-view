		...
		return (
			...
			>
				<View style={ListItemStyle.btnContainer}>
					<Text style={[(defaultSelected && Name ==! defaultSelected.Name) && ListItemStyle.notSelected || (defaultSelected && Name === defaultSelected.Name) && ListItemStyle.selected]}>{Name}</Text>
				</View >
			</TouchableOpacity>
		);
	}
